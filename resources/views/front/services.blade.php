...
<head>
    <title>Go Travel a Travel Category Flat Bootstrap Responsive Website Template | Services :: w3layouts</title>
                ...
                <div class="services-grids w3ls-agileits">
                    <div class="col-md-4 services-grid">
                        <div class="ser1">
                            ...
                            <p>Were dolor in hendrerit in vulputate velit esse molestie con sequat,Nulla consectetur
                                maximus sem vel aliquet. Donec blandit condimentum varius</p>
                        </div>
                    </div>
                    <div class="col-md-4 services-grid">
                        <div class="ser1">
                ...
                <div class="features-grids w3ls-agileits">
                    <div class="col-md-3 feature-grid">
                        <div class="feature">
                            ...
                            <div class="feature2">
                                <p>Quisque nulla. Vestibulum libero nisl, porta vel, scelerisque eget, lesuada at,
                                    neque. Viv eget nibh. Etam cus. Nulla facilisi. </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 feature-grid">
                ...
                <div class="servic-grids w3ls-agileits">
                    <div class="service1">
                        ...
                        <div class="col-md-3 service-grid1">
                            ...
                            <p>Fusce feugiat malesuada odio. Morbi orci. Donec sit amet eros. Lorem ipsum dolor sit
                                amet, consectetuer adipiscing elit. Mauris fermentum dictum magna.</p>
                        </div>
                        <div class="col-md-3 service-grid">
                    ...
                    <div class="service2">
                        ...
                        <div class="col-md-3 service-grid">
                            <img src={{ 'tema/images/e4.jpg' }} class="img-responsive" alt="">
                        </div>
                        <div class="col-md-3 service-grid1">
                            <h4>Mauris non magna ul </h4>
                            <p>Fusce feugiat malesuada odio. Morbi orci. Donec sit amet eros. Lorem ipsum dolor sit
